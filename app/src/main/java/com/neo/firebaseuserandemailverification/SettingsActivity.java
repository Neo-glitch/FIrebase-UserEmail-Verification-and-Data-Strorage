...
public class SettingsActivity extends AppCompatActivity implements
    ...
    private void init() {
        ...
        mSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                 ...
                 */
                if (mSelectedImageUri != null) {   // if image is from disk
        ...
        mProfileImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mStoragePermissions) {
                    // pops up dialog for user to get image from cam or on disk
    ...
    public class BackgroundImageResize extends AsyncTask<Uri, Integer, byte[]> {
        ...
        protected byte[] doInBackground(Uri... params) {
            ...
            if (mBitmap == null) {     // true when image is from disk
                try {
    ...
    private void executeUploadTask() {
        ...
        if (mBytes.length / MB < MB_THRESHHOLD) {   // upload opp only when compressed image < 5MB

            // Create file metadata including the content type
            StorageMetadata metadata = new StorageMetadata.Builder()
                    .setContentType("image/jpg")
                    .setContentLanguage("en")           // Make sure to use proper language code ("English" will cause a crash)
                    .setCustomMetadata("Neo's special meta data", "JK nothing special here")
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            Uri firebaseURL = uri;
                            Log.d(TAG, "onSuccess: Download URL is: " + firebaseURL.toString());
                            Toast.makeText(SettingsActivity.this, "Upload Success", Toast.LENGTH_SHORT).show();
                            // write the downloadUrl of the file to the fb database
        ...
        query1.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot singleSnapshot : dataSnapshot.getChildren()) {
                    ...
                    Picasso.get().load(user.getProfile_image()).into(mProfileImage);
                }
            }
    ...
    public void verifyStoragePermissions() {
        ...
        } else { // all permissions not granted, so request them again
