package com.neo.firebaseuserandemailverification.models;


/**
 * custom java obj to be inserted to FirebaseDatabase
 */
public class User {
    ...
    public User() {                 // needed for passing class obj to firebase method
        this.name = name;
        this.phone = phone;
        this.profile_image = profile_image;
        this.security_level = security_level;
