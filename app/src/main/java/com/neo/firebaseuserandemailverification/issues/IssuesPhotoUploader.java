...
public class IssuesPhotoUploader {
    ...
    private boolean mIsUploadingAttachments = false;                                                // true when what we're uploading is attachment and not profile photo
    ...
    /**
     * uploads attachment photo on cloudStorage
     *
     * @param imageUri
     */
    ...
    /**
     * AysncTask that conv image resource to a byteArray for compression
     */
    ...
    private void executeUploadTask() {
        ...
        String uploadPath = "";
        String format = "";
        if (!mIsUploadingAttachments) {   // for project avatar
    ...
    /**
     * create a new attachment doc in the attachments collection
     */
